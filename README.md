...
Experienced in building complete systems from architecture design to deployment, including REST APIs, payment integrations, authentication systems, dashboards, and responsive interfaces.

Skilled in MVC and MVVM architectures, native Android development, scalable back-end solutions, database modeling, and modern front-end development using React and Node.js ecosystems.

Focused on clean architecture, maintainability, performance, and real-world business solutions.
